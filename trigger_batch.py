...
def send_to_n8n(project_name, file_links):
    # 'cognitcentric' -> 'cognicentric' olaraq düzəldildi
    # n8n-də workflow aktivdirsə 'webhook' (production) istifadə olunmalıdır, amma sən 'webhook-test' verdiyin üçün onu saxlayıram.
    webhook_url = "https://n8n.alikhanli.site/webhook-test/cognicentric/audio"
    auth = ("voice", "voice123")
    payload = {
    ...
    try:
        ...
        if response.status_code == 404:
            ...
            prod_url = "https://n8n.alikhanli.site/webhook/cognicentric/audio"
